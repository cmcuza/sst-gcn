...
parser.add_argument('--data', type=str, default=p.join('data', 'rm_0.5', 'chengdu40'), help='data path')
parser.add_argument('--adjdata', type=str,default=p.join('data', 'rm_0.5', 'chengdu40', 'edge_adj.pickle'), help='adj data path')
